...
!(function (a, b) {
  (a.MixItUp = function () {
    ...
    (a.MixItUp.prototype = {
      ...
      _filters: {},
      extend(b) {
        for (const c in b) a.MixItUp.prototype[c] = b[c];
      },
      addAction(b, c, d, e) {
      ...
      _init(b, c) {
        ...
        if (
          ...
          d._buildToggleArray();
          for (let e = 0; e < d._toggleArray.length; e++)
            d._updateControls(
      ...
      _platformDetect() {
        ...
        const d = ['webkit', 'moz'];
        const e = window.navigator.appVersion.match(/Chrome\/(\d+)\./) || !1;
        const f = typeof InstallTrigger !== 'undefined';
        const g = function (a) {
        ...
        for (let i = 0; i < d.length && !window.requestAnimationFrame; i++)
      ...
      _refresh(a, c) {
        ...
        for (var e = 0; e < d._$targets.length; e++) {
          ...
          if (f.dataset === b || c) {
            f.dataset = {};
            for (let g = 0; g < f.attributes.length; g++) {
              const h = f.attributes[g];
              const i = h.name;
              const j = h.value;
              if (i.indexOf('data-') > -1) {
                const k = d._helpers._camelCase(i.substring(5, i.length));
                f.dataset[k] = j;
              }
            }
          }
      ...
      _bindHandlers() {
        const c = this;
        const d = a.MixItUp.prototype._bound._filter;
        const e = a.MixItUp.prototype._bound._sort;
      ...
      _processClick(c, d) {
        const e = this;
        const f = function (c, d, f) {
          const g = a.MixItUp.prototype;
        ...
        if (
          ...
          if (((e._clicking = !0), d === 'sort')) {
            const g = c.attr('data-sort');
          ...
          if (d === 'filter') {
            let h;
            const i = c.attr('data-filter');
            const j = e.controls.toggleLogic === 'or' ? ',' : '';
            e.controls.toggleFilterButtons
              ? (e._buildToggleArray(),
                ...
                (e._toggleArray = a.grep(e._toggleArray, (a) => a)),
      ...
      _updateControls(c, d) {
        const e = this;
        const f = { filter: c.filter, sort: c.sort };
        const g = function (a, b) {
          d && h === 'filter' && f.filter !== 'none' && f.filter !== ''
      ...
      _filter() {
        ...
        for (let c = 0; c < b._$targets.length; c++) {
          const d = a(b._$targets[c]);
      ...
      _sort() {
        ...
        const b = function (a) {
          for (var b = a.slice(), c = b.length, d = c; d--; ) {
            const e = parseInt(Math.random() * c);
            const f = b[d];
            (b[d] = b[e]), (b[e] = f);
          }
          return b;
        ...
        for (let c = 0; c < a._$targets.length; c++) {
          const d = a._$targets[c];
      ...
      _compare(a, b, c) {
        c = c || 0;
        const d = this;
        const e = d._newSort[c].order;
        const f = function (a) {
          return a.dataset[d._newSort[c].sortBy] || 0;
        };
        const g = isNaN(1 * f(a)) ? f(a).toLowerCase() : 1 * f(a);
        const h = isNaN(1 * f(b)) ? f(b).toLowerCase() : 1 * f(b);
        return h > g
          ? e === 'asc'
            ? -1
            : 1
      ...
      _printSort(a) {
        const b = this;
        const c = a ? b._startOrder : b._newOrder;
        const d = b._$parent[0].querySelectorAll(b.selectors.target);
        const e = d.length ? d[d.length - 1].nextElementSibling : null;
        const f = document.createDocumentFragment();
        b._execAction('_printSort', 0, arguments);
        for (var g = 0; g < d.length; g++) {
          const h = d[g];
          const i = h.nextSibling;
          h.style.position !== 'absolute' &&
            (i && i.nodeName === '#text' && b._$parent[0].removeChild(i),
            b._$parent[0].removeChild(h));
        }
        for (var g = 0; g < c.length; g++) {
          const j = c[g];
          if (
            b._newSort[0].sortBy !== 'default' ||
            b._newSort[0].order !== 'desc' ||
            a
          )
            f.appendChild(j), f.appendChild(document.createTextNode(' '));
          else {
            const k = f.firstChild;
            f.insertBefore(j, k),
      ...
      _parseSort(a) {
        for (
          ...
          const f = typeof a === 'string' ? c[e].split(':') : ['custom', c[e]];
          const g = {
            sortBy: b._helpers._camelCase(f[0]),
            order: f[1] || 'asc',
          };
          if ((d.push(g), g.sortBy === 'default' || g.sortBy === 'random'))
            break;
        }
      ...
      _parseEffects() {
        ...
        const c = function (b, c) {
          if (a.animation.effects.indexOf(b) > -1) {
            if (c) {
              const d = a.animation.effects.indexOf(`${b}(`);
              if (d > -1) {
                const e = a.animation.effects.substring(d);
                const f = /\(([^)]+)\)/.exec(e);
                const g = f[1];
                return { val: g };
              }
        ...
        return (
          ...
          (b.transition = a._getPrefixedCSS(
            'transition',
            `all ${a.animation.duration}ms ${a.animation.easing}, opacity ${a.animation.duration}ms linear`,
          )),
      ...
      _goMix(a) {
        const b = this;
        const c = function () {
          b._chrome && b._chrome === 31 && f(b._$parent[0]), b._setInter(), d();
        };
        var d = function () {
        ...
        var e = function () {
          b._animateTargets(), b._targetsBound === 0 && b._cleanUp();
        };
        var f = function (a) {
      ...
      _getOrigMixData() {
        ...
        const c = b.boxSizing || b[`${a._vendor}BoxSizing`];
        (a._incPadding = c === 'border-box'),
          ...
          (a._startHeight = a._incPadding
            ...
            : a._$parent.height());
        for (let d = 0; d < a._$pre.length; d++) {
          const e = a._$pre[d];
        ...
        for (var c = 0; c < b._$pre.length; c++) {
          ...
          (d.dataset.finalPosX !== d.dataset.origPosX ||
            ...
            e.css(
              b._getPrefixedCSS(
                'transition',
                `all ${b.animation.duration}ms ${b.animation.easing} ${g}ms`,
              ),
            ),
            e.css(
              b._getPrefixedCSS('transform', `translate(${f.x}px,${f.y}px)`),
            ),
            b.animation.animateResizeTargets &&
      ...
      _bindTargetDone(b) {
        ...
        c._execAction('_bindTargetDone', 0, arguments),
          d.dataset.bound ||
            ((d.dataset.bound = !0),
            c._targetsBound++,
            b.on('webkitTransitionEnd.mixItUp transitionend.mixItUp', (e) => {
      ...
      _cleanUp() {
        const b = this;
        const c = b.animation.animateResizeTargets
      ...
      _getPrefixedCSS(a, b, c) {
        const d = this;
        const e = {};
        for (i = 0; i < 2; i++) {
          const f = i === 0 ? d._prefix : '';
          e[f + a] = c ? f + b : b;
        }
      ...
      _getDelay(a) {
        const b = this;
        const c =
          typeof b.animation.staggerSequence === 'function'
            ? b.animation.staggerSequence.call(b._domNode, a, b._state)
            : a;
        const d = b.animation.stagger ? c * b.animation.staggerDuration : 0;
        return b._execFilter('_getDelay', d, arguments);
      },
      _parseMultiMixArgs(a) {
        for (
          var b = this,
          ...
          e !== null &&
            (typeof e === 'object' || typeof e === 'string'
              ...
              : typeof e === 'boolean'
              ? (c.animate = e)
              : typeof e === 'function' && (c.callback = e));
        }
      ...
      _parseInsertArgs(b) {
        for (
          ...
          typeof f === 'number'
            ? (d.index = f)
            : typeof f === 'object' && f instanceof a
            ? (d.$object = f)
            : typeof f === 'object' && c._helpers._isElement(f)
            ? (d.$object = a(f))
            : typeof f === 'object' && f !== null
            ? (d.multiMix = f)
            : typeof f !== 'boolean' || f
            ? typeof f === 'function' && (d.callback = f)
            : (d.multiMix = !1);
        }
      ...
      _execAction(a, b, c) {
        ...
        if (!d._actions.isEmptyObject && d._actions.hasOwnProperty(a))
          for (const f in d._actions[a][e]) d._actions[a][e][f].call(d, c);
      },
      _execFilter(a, b, c) {
        const d = this;
        if (d._filters.isEmptyObject || !d._filters.hasOwnProperty(a)) return b;
        for (const e in d._filters[a]) return d._filters[a][e].call(d, c);
      },
      _helpers: {
        _camelCase(a) {
          return a.replace(/-([a-z])/g, (a) => a[1].toUpperCase());
        },
        _isElement(a) {
          return window.HTMLElement
            ? a instanceof HTMLElement
            : a !== null && a.nodeType === 1 && a.nodeName === 'string';
        },
      },
      isMixing() {
        const a = this;
      ...
      filter() {
        const a = this;
        const b = a._parseMultiMixArgs(arguments);
      ...
      multiMix() {
        ...
        if ((a._execAction('multiMix', 0, arguments), a._mixing))
          ...
          const d = c.command.sort;
          let e = c.command.filter;
          const f = c.command.changeLayout;
          a._refresh(),
            d &&
              ...
              a._sort()),
            e !== b &&
              ((e = e === 'all' ? a.selectors.target : e),
              (a._activeFilter = e)),
            a._filter(),
            f &&
              ((a._newDisplay =
                typeof f === 'string' ? f : f.display || a.layout.display),
      ...
      insert() {
        const a = this;
        const b = a._parseInsertArgs(arguments);
        const c = typeof b.callback === 'function' ? b.callback : null;
        const d = document.createDocumentFragment();
        const e = (function () {
          return (
            a._refresh(),
        ...
        if ((a._execAction('insert', 0, arguments), b.$object)) {
          for (let f = 0; f < b.$object.length; f++) {
            const g = b.$object[f];
        ...
        a._execAction('insert', 1, arguments),
          typeof b.multiMix === 'object' && a.multiMix(b.multiMix, c);
      },
      prepend() {
        const a = this;
        const b = a._parseInsertArgs(arguments);
      ...
      setOptions(b) {
        ...
        c._execAction('setOptions', 0, arguments),
          typeof b === 'object' && a.extend(!0, c, b),
      ...
      destroy(b) {
        ...
        c._execAction('destroy', 0, arguments),
          c._$body
            ...
            .off('.mixItUp');
        for (let d = 0; d < c._$targets.length; d++) {
          const e = c._$targets[d];
      ...
      return (
        (c = this.each(function () {
          if (d && typeof d[0] === 'string') {
            const c = a.MixItUp.prototype._instances[this.id];
            if (d[0] === 'isLoaded') e.push(c ? !0 : !1);
            else {
              const g = c[d[0]](d[1], d[2], d[3]);
              g !== b && e.push(g);
            }
          } else f(this, d[0]);
        })),
